...
<div class="ywcwat_product_watermark_row" id="ywcwat_product_watermark_row-<?php echo $current_row;?>">
    <div class="options_group ywcwat_product_collapse">
        <input type="button" class="button button-secondary ywcwat_remove_product_watermark" data-element_id="<?php echo $current_row;?>" value="<?php _e('Remove', 'yith-woocommerce-watermark');?>" style="float:left" />
  ...
  <div class="ywcwat_product_watermark_container">
    <div class="options_group ywcwat_product_type_watermark">
        <p class="form-field ywcwat_select_type">
            ...
            <select class="ywcwat_select_type_wat" name="<?php echo esc_attr($option_id);?>[<?php echo $current_row;?>][ywcwat_watermark_type]">
    ...
    <div class="options_group ywcwat_custom_wat_text_fields">
        <p class="form-field">
            ...
            <input type="text" class="product_ywcwat_text" name="<?php echo esc_attr($option_id);?>[<?php echo $current_row;?>][ywcwat_watermark_text]" value="<?php echo $watermark_text;?>" placeholder="<?php _e('Write a text','yith-woocommerce-watermark');?>">
        </p>
        <p class="form-field">
            ...
            <select class="product_ywcwat_font" name="<?php echo esc_attr($option_id);?>[<?php echo $current_row;?>][ywcwat_watermark_font]" style="text-transform: capitalize;" >
        ...
        <p class="form-field">
            ...
            <input type="number" class="product_ywcwat_font_size" name="<?php echo esc_attr($option_id);?>[<?php echo $current_row;?>][ywcwat_watermark_font_size]" min=0  max=100 value="<?php echo $watermark_font_size;?>">
        ...
        <p class="form-field">
            ...
            <input type="text" class="product_colorpicker product_ywcwat_font_color" name="<?php echo esc_attr($option_id);?>[<?php echo $current_row;?>][ywcwat_watermark_font_color]" value="<?php echo $watermark_font_color;?>"
                   data-default-color="#000000">
        </p>
        <p class="form-field">
            <label for="ywcwat_watermark_bg_color"><?php _e('Background Color','yith-woocommerce-watermark');?></label>
            <input type="text" class="product_colorpicker product_ywcwat_bg_color" name="<?php echo esc_attr($option_id);?>[<?php echo $current_row;?>][ywcwat_watermark_bg_color]" value="<?php echo $watermark_bg_color;?>"
                   data-default-color="#ffffff">
        </p>
        <p class="form-field">
            <label for="ywcwat_watermark_opacity"><?php _e('Opacity','yith-woocommerce-watermark');?></label>
            <input type="number" class="product_ywcwat_opacity" name="<?php echo esc_attr($option_id);?>[<?php echo $current_row;?>][ywcwat_watermark_opacity]" value="<?php echo $watermark_opacity;?>" min=0 max=100 value="<?php echo $watermark_opacity;?>">
  ...
  100 for complete opacity','yith-woocommerce-watermark');?></span>
        ...
        <p class="form-field">
            ...
            <input type="number" class="product_ywcwat_box_width" min=0 max="100" name="<?php echo esc_attr($option_id);?>[<?php echo $current_row;?>][ywcwat_watermark_width]" value="<?php echo $watermark_box_width;?>" >
        ...
        <p class="form-field">
            ...
            <input type="number" class="product_ywcwat_box_height" min=0 name="<?php echo esc_attr($option_id);?>[<?php echo $current_row;?>][ywcwat_watermark_height]" value="<?php echo $watermark_box_height;?>" >
        ...
        <p class="form-field">
            ...
            <input type="number" class="product_ywcwat_line_height" min=-1 name="<?php echo esc_attr($option_id);?>[<?php echo $current_row;?>][ywcwat_watermark_line_height]" value="<?php echo $watermark_line_height;?>" >
    ...
    <div class="options_group ywcwat_custom_wat_img_fields">
        <p class="form-field">
            ...
            <input type="text" class="ywcwat_product_wat_url" id="ywcwat_product_wat_url-<?php echo $current_row;?>" value="<?php echo $watermark_url;?>">
            <input type="button" class="button button-secondary ywcwat_product_image" value="<?php _e('Select Watermark', 'yith-woocommerce-watermark');?>" data-choose="<?php _e('Select Watermark', 'yith-woocommerce-watermark');?>">
            <input type="hidden" name="<?php echo esc_attr($option_id);?>[<?php echo $current_row;?>][ywcwat_watermark_id]" id="ywcwat_product_image_hidden-<?php echo $current_row;?>" value="<?php echo $watermark_id;?>">
        </p>
        <p class="form-field">
    ...
    <div class="options_group ywcwat_custom_general_fields">
        <div class="form-field position_table">
            ...
            <input type="hidden" name="<?php echo esc_attr($option_id);?>[<?php echo $current_row;?>][ywcwat_watermark_position]" class="product_ywcwat_pos_value" value="<?php echo $watermark_position;?>">
        </div>
    ...
    <div class="options_group ywcwat_margin">
        <p class="form-field">
            ...
            <input type="number" class="ywcwat_prod_margin_x" name="<?php echo esc_attr($option_id);?>[<?php echo $current_row;?>][ywcwat_watermark_margin_x]" value="<?php echo $watermark_margin_x;?>">
        </p>
        <p class="form-field">
            <label for="ywcwat_margin_y"><?php _e( 'Margin Y','yith-woocommerce-watermark');?></label>
            <input type="number" class="ywcwat_prod_margin_y" name="<?php echo esc_attr($option_id);?>[<?php echo $current_row;?>][ywcwat_watermark_margin_y]" value="<?php echo $watermark_margin_y;?>">
        </p>
    </div>
    <div class="options_group ywcwat_product_size_option">
        <p class="form-field">
            ...
            <select name="<?php echo esc_attr($option_id);?>[<?php echo $current_row;?>][ywcwat_watermark_sizes]" class="ywcwat_product_size">
                <?php
                $wc_sizes = array(
    ...
    <div class="options_group ywcwat_preview">
        <?php $is_full =  $watermark_sizes == 'full';?>
        <div class="form-field product_ywcwat_preview" style="display :<?php echo $is_full ? 'none;' : 'block;';?>">
            <label for="product_ywcwat_preview"><?php _e('Preview','yith-woocommerce-watermark');?></label>
            <div class="ywcwat_preview_bg">
        ...
        <div class="form-field ywcwat_settings_full_size" style="display :<?php echo !$is_full ? 'none;' : 'block;';?>">
            <label for="product_ywcwat_preview"><?php _e('Preview','yith-woocommerce-watermark');?></label>
            <span class="description"><?php _e('It is not possible to preview the image, as the result depends on the size of the original images','yith-woocommerce-watermark');?></span>
        </div>
    </div>
  </div>
</div>